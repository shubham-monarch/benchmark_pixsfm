...
# Read the PLY file
plydata_sfm_in_camera_frame = PlyData.read('/home/skumar/slam-helpers/p360_dataset/ply/sfm_in_camera_frame_orange.ply')
plydata_sfm = PlyData.read('/home/skumar/slam-helpers/p360_dataset/ply/sfm_cyan.ply')
...
v1 = plydata_sfm_in_camera_frame['vertex'].data
v2 = plydata_svo['vertex'].data
v3 = plydata_sfm['vertex'].data 
...
rr.log("sfm_in_camera_frame",rr.Points3D(p1, colors=c1, radii=0.01))
rr.log("svo",rr.Points3D(p2, colors=c2, radii=0.01  ))
rr.log("sfm",rr.Points3D(p3, colors=c3, radii=0.01  ))
