...
# Read the PLY file
plydata_sfm = PlyData.read('/home/skumar/benchmark_pixSFM/ply/sfm_yellow.ply')
plydata_svo = PlyData.read('/home/skumar/benchmark_pixSFM/ply/svo_pink.ply')
plydata_sfm_in_camera_frame = PlyData.read('/home/skumar/benchmark_pixSFM/ply/sfm_yellow_old.ply')
...
rr.log(
    "sfm",
    rr.Points3D(p1, colors=c1, radii=0.5),
)

rr.log(
    "svo",
    rr.Points3D(p2, colors=c2, radii=0.5)
)

rr.log(
    "sfm_in_camera_frame",
    rr.Points3D(p3, colors=c3, radii=0.5)
)
